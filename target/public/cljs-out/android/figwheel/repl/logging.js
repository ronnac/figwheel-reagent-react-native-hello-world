...
try{return cljs.core.reduce.call(null,cljs.core._PLUS_,cljs.core.map.call(null,cljs.core._STAR_,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(100000000000),(10000),(1)], null),cljs.core.map.call(null,(function (p1__9781_SHARP_){
return parseInt(p1__9781_SHARP_);
...
var c_9784 = (new goog.debug.Console());
var G__9783_9785 = c_9784.getFormatter();
goog.object.set(G__9783_9785,"showAbsoluteTime",false);

goog.object.set(G__9783_9785,"showRelativeTime",false);


goog.object.set(goog.debug.Console,"instance",c_9784);
...
figwheel.repl.logging.log_levels = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,cljs.core.juxt.call(null,clojure.string.lower_case,(function (p1__9786_SHARP_){
return goog.object.get(goog.debug.Logger.Level,p1__9786_SHARP_);
