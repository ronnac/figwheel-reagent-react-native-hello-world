...
var G__14274 = o;
goog.object.set(G__14274,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__14275__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__14275 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__14276__i = 0, G__14276__a = new Array(arguments.length -  0);
while (G__14276__i < G__14276__a.length) {G__14276__a[G__14276__i] = arguments[G__14276__i + 0]; ++G__14276__i;}
  args = new cljs.core.IndexedSeq(G__14276__a,0,null);
} 
return G__14275__delegate.call(this,args);};
G__14275.cljs$lang$maxFixedArity = 0;
G__14275.cljs$lang$applyTo = (function (arglist__14277){
var args = cljs.core.seq(arglist__14277);
return G__14275__delegate(args);
});
...
var G__14278 = o;
goog.object.set(G__14278,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__14279__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
...
while (G__14280__i < G__14280__a.length) {G__14280__a[G__14280__i] = arguments[G__14280__i + 0]; ++G__14280__i;}
  args = new cljs.core.IndexedSeq(G__14280__a,0,null);
} 
return G__14279__delegate.call(this,args);};
G__14279.cljs$lang$maxFixedArity = 0;
G__14279.cljs$lang$applyTo = (function (arglist__14281){
var args = cljs.core.seq(arglist__14281);
return G__14279__delegate(args);
});
...
var G__14282 = props;
var G__14282__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__14282,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__14282);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__14282__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__14283 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__14283,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__14283;
}
})(),id_class);
...
var G__14284 = (cljs.core.count.call(null,argv) - first_child);
switch (G__14284) {
case (0):
...
var vec__14286 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__14286,(0),null);
var id = cljs.core.nth.call(null,vec__14286,(1),null);
var className = cljs.core.nth.call(null,vec__14286,(2),null);
...
var temp__5757__auto___14289 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5757__auto___14289 == null)){
} else {
var key_14290 = temp__5757__auto___14289;
(jsprops.key = key_14290);
}
...
var temp__5757__auto___14291 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5757__auto___14291 == null)){
} else {
var key_14292 = temp__5757__auto___14291;
(jsprops.key = key_14292);
}
...
var temp__5757__auto___14293 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5757__auto___14293 == null)){
} else {
var key_14294 = temp__5757__auto___14293;
(jsprops.key = key_14294);
}
...
var temp__5757__auto___14295 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5757__auto___14295 == null)){
} else {
var key_14296 = temp__5757__auto___14295;
(jsprops.key = key_14296);
}
...
var temp__5757__auto___14297 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5757__auto___14297 == null)){
} else {
var key_14298 = temp__5757__auto___14297;
(jsprops.key = key_14298);
}
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__14299_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__14299_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__14300 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__14300,(0),null);
var derefed = cljs.core.nth.call(null,vec__14300,(1),null);
...
break;
default:
var G__14305 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__14306 = compiler;
v = G__14305;
compiler = G__14306;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template14310 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template14310 = (function (opts,id,fn_to_element,parse_fn,meta14311){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template14310.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_14312,meta14311__$1){
var self__ = this;
var _14312__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template14310(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta14311__$1));
}));

(reagent.impl.template.t_reagent$impl$template14310.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_14312){
var self__ = this;
var _14312__$1 = this;
return self__.meta14311;
}));

(reagent.impl.template.t_reagent$impl$template14310.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template14310.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template14310.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
return self__.parse_fn.call(null,this$__$1,tag_name,tag_value);
}));

(reagent.impl.template.t_reagent$impl$template14310.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template14310.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template14310.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta14311","meta14311",-760746074,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template14310.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template14310.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template14310");

(reagent.impl.template.t_reagent$impl$template14310.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write.call(null,writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template14310");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template14310.
 */
reagent.impl.template.__GT_t_reagent$impl$template14310 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template14310(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta14311){
return (new reagent.impl.template.t_reagent$impl$template14310(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta14311));
});

}

return (new reagent.impl.template.t_reagent$impl$template14310(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
